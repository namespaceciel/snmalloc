#if defined(SNMALLOC_PASS_THROUGH) || defined(_WIN32) || !defined(TODO_REINSTATE_POSSIBLY)
...
using ExternalChunkmap = ExternalGlobalPagemapTemplate<ChunkmapPagemap, snmalloc_chunkmap_global_get>;
