...
class DefaultPagemapEntryT : public FrontendMetaEntry<SlabMetadata> {
     ...
     */
    template<SNMALLOC_CONCEPT(IsPAL) A1, typename A2, typename A3, typename A4, typename A5>
...
class DefaultSlabMetadata
    : public FrontendSlabMetadata<DefaultSlabMetadata<ClientMetaDataProvider>, ClientMetaDataProvider> {};
