 ...
 * can be used.
 */
template<typename PAL, typename Pagemap, typename Base = EmptyRange<>, size_t MinSizeBits = MinBaseSizeBits<PAL>()>
...
public:
    ...
    using LargeObjectRange =
        Pipe<Stats,
             StaticConditionalRange<LargeBuddyRange<LocalCacheSizeBits, LocalCacheSizeBits, Pagemap, page_size_bits>>>;
