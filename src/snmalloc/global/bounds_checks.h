...
SNMALLOC_SLOW_PATH SNMALLOC_UNUSED_FUNCTION inline FakeReturn report_fatal_bounds_error(const void* ptr, size_t len,
                                                                                        const char* msg) {
    if constexpr (FailFast) {
        ...
        report_fatal_error("Fatal Error!\n{}: \n\trange [{}, {})\n\tallocation [{}, "
                           ...
                           msg, p, range_end, alloc.template external_pointer<Start>(p), object_end,
